...
<div class="row">
	<div class="col-md-10"><h2><span class="glyphicon glyphicon-book"></span> {{{$Carrera->nombre}}} <small></small></h2></div>
</div>
...
<div class="pull-right">
	<p>{{ link_to('Categorias', ' Regresar', array('class' => 'btn btn-success glyphicon glyphicon-chevron-left')) }}</p>
</div>

...
<div id="container">
  <div class="row">
    <div class="col-md-6" id="titulo"><h2><span class="glyphicon glyphicon-file"></span> Instituciones <small> &gt; Nueva Institución </small></h2></div>
  </div>
...
{{ Form::open(array('route' => 'Instituciones.store', 'class' => "form-horizontal" , 'role' => 'form')) }}

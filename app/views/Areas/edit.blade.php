...
<div id="container">
  <div class="row">
    <div class="col-md-4" id="titulo"><h2><span class="glyphicon glyphicon-pencil"></span> Áreas <small> &gt; Editar Área </small> </h2></div>
  </div>
...
{{ Form::model($Area, array('method' => 'PATCH', 'route' => array('Areas.update', $Area->id), 'class' => "form-horizontal" , 'role' => 'form')) }}

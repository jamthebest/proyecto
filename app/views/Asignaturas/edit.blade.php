...
<div id="container">
  <div class="row">
    <div class="col-md-6" id="titulo"><h2><span class="glyphicon glyphicon-pencil"></span> Asignaturas <small> &gt; Editar Asignatura </small> </h2></div>
  </div>
...
{{ Form::model($Asignatura, array('method' => 'PATCH', 'route' => array('Asignaturas.update', $Asignatura->id), 'class' => "form-horizontal" , 'role' => 'form')) }}
